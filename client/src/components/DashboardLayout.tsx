...
const menuItems = [
  ...
  { icon: Settings, label: "Sessões WhatsApp", path: "/sessions" },
];
        ...
        <div className="flex flex-col items-center gap-8 p-8 max-w-md w-full">
          ...
          <div className="flex flex-col items-center gap-3 text-center">
            ...
            <p className="text-sm text-muted-foreground max-w-sm">
              Faça login para acessar o painel de disparos WhatsApp.
            </p>
          </div>
          <Button
      ...
      <div className="relative" ref={sidebarRef}>
        <Sidebar collapsible="icon" className="border-r border-sidebar-border bg-sidebar" disableTransition={isResizing}>
              ...
              {!isCollapsed && (
                <div className="flex items-center gap-2 min-w-0">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-xs text-sidebar-foreground/40 truncate">API Oficial Meta</p>
                  </div>
                </div>
              )}
            </div>
          ...
          <SidebarContent className="gap-0 py-3">
                ...
                return (
                  <SidebarMenuItem key={item.path}>
                    <SidebarMenuButton
                      ...
                      tooltip={item.label}
                      className={`h-10 rounded-lg transition-all font-normal ${
                        isActive
            ...
            {/* Admin section */}
            {user?.role === "admin" && (
              <SidebarMenu className="px-2 mt-2 pt-2 border-t border-sidebar-border/50 space-y-0.5">
                ...
                <button className="flex items-center gap-3 rounded-lg px-2 py-2 hover:bg-sidebar-accent transition-colors w-full text-left focus:outline-none">
                  ...
                  {!isCollapsed && (
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-sidebar-foreground/40 truncate mt-1">
                        {user?.email ?? ""}
                      </p>
                    </div>
                  )}
